...
| AVX2 + prefetch | 10.7 ms | 22.7 GiB/s | ✅ Verified (W3) — bus-saturated at 1T (~29 GB/s actual with write-allocate) |
| AVX2 + prefetch + MT | no scaling | — | ✅ Verified (W3) — 1T already at DRAM ceiling, threading adds overhead |
| Popcount ST | 3.80 ms | 15.9 GiB/s | ✅ Verified (W3) — headroom exists (40% of peak) |
| Popcount MT (8 threads) | 2.23 ms | 29.2 GiB/s | ✅ Verified (W3) — 1.70× scaling, 73% of theoretical peak |
